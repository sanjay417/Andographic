...
export default class PermissionDeveloper extends Component {
    ...
    plotGraph = () =>{
        ...
        for(let i = 0; i < permissionCount.length; i++){
            let obj = permissionCount[i];
            let permTotal = Math.round(obj.total);
    ...
    renderChart =()=>{
        ...
        const chartOptions = {
            title : "Average Permission usage by Developer  ",
